"""Command line interface for EWA-Reward."""
...
def build_parser() -> argparse.ArgumentParser:
    """中文：构造 ewa-reward 命令行参数解析器。
English: Build the argument parser for the ewa-reward command."""
    parser = argparse.ArgumentParser(
        prog="ewa-reward",
        description="EWA-Reward: agentic reward evaluation service for embodied world-model videos.",
    )
    parser.add_argument("--version", action="version", version=f"ewa-reward {__version__}")
